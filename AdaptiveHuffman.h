...
#define ROOT_NODE 0
#define MAX_WEIGHT 0x8000 //this happens soonner than 0xffff
#define TRUE 1
#define FALSE 0
...
void RebuildTree(Tree& tree) {
	...
	//assigned a weight. The weight is simpy the sum of the two nodes at location i. After the node j
